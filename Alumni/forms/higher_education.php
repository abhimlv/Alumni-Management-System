...
<?php
    ...
    if (isset($_POST['Add'])) {
        ...
        $sqlI = "INSERT INTO higher_studies(A_id, Institute_name, course_name, yearof_admission, yearof_passout, other_degrees) 
                VALUES('$Alumni_id','$Institute_name','$course_name','$yearof_admission','$yearof_passout', '$other_degrees')"; 
                            ...
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="other_degrees"
                                                name="other_degrees" class="span8" ><br><br>
                                            </div>
                                        </div>
