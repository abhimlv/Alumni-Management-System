...
<?php
    ...
    if (isset($_POST['Register'])) {
        ...
        $alumni_Email2 = $_POST['alumni_Email2'];
        ...
        if (!filter_var($alumni_Email2, FILTER_VALIDATE_EMAIL)) {
            $error = true;  
            $emailErr = "Invalid email format"; 
          }
        ...
        if (!$error) {
            ...
            $sql = "INSERT INTO alumni(Alumni_name, Alumni_gender, Alumni_contactNo, Alumni_email, Alumni_email2, Alumni_address, Alumni_password) VALUES ('$alumni_name','$gender','$alumniPhoneNo','$alumni_Email','$alumni_Email2','$alumni_Address','$password')";    
                            ...
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"
                                                name="alumni_Email" id="email" placeholder="Email" class="span8" required><br>
                                                <p style="color: red;"><?php if(isset($emailErr)) echo $emailErr; ?></p><br>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="email">Work Email</label>
                                            <div class="controls">
                                                <input type="text"
                                                name="alumni_Email2" id="email" placeholder="Email" class="span8" required><br>
                                                <p style="color: red;"><?php if(isset($emailErr)) echo $emailErr; ?></p><br>
                                            </div>
                                        </div>
