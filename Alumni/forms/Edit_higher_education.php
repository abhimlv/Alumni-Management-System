...
<?php
    ...
    include_once('../../config/dbconnect.php');
        ...
        $row = mysqli_fetch_object($queryHS);
            ...
            $yearof_admission = $row->yearof_admission;
            $yearof_passout = $row->yearof_passout;
    ...
    if (isset($_POST['Update'])) {
        ...
        $yearof_admission = $_POST['yearof_admission'];
        $yearof_passout = $_POST['yearof_passout'];
        $other_degrees = $_POST['other_degrees'];


        $sqlU = "UPDATE higher_studies SET Institute_name='$_POST[Institute_name]', course_name='$_POST[course_name]', yearof_admission='$_POST[yearof_admission]', yearof_passout='$_POST[yearof_passout]', other_degrees='$_POST[other_degrees]'
                        ...
                        <div class="content">
                            ...
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="yearof_admission">Year of admission</label>
                                            <div class="controls">
                                                <input type="date" id="yearof_admission"
                                                name="yearof_admission" class="span8" required><br><br>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="yearof_passout">Year of passout</label>
                                            <div class="controls">
                                                <input type="date" id="yearof_passout"
                                                name="yearof_passout" class="span8" required><br><br>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="other_degrees">Other Degrees</label>
                                            <div class="controls">
                                                <input type="text" id="other_degrees" value="<?php echo $other_degrees; ?>" name="other_degrees" class="span8"><br><br>
                                            </div>
                                        </div>
